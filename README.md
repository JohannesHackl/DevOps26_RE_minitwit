...
- '/go/src/bin' => Contains the binary which is compiled to simply typing 'gobuild' in the terminal

The docker container has a builtin script to compile the go module located at /go/src/ you simply need to run 'gobuild' and it will build the project to /go/src/bin/
